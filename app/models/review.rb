class Review < ActiveRecord::Base
  ...
  def self.search(search)
    ...
    find(:all, :conditions => ['(title LIKE ? OR message LIKE ? OR review_type LIKE ? OR ticket_number LIKE ? ) && ispublished is like true', search_condition, search_condition,search_condition,search_condition])
  end
